 ...
 * in each tab are pre-filtered to that category.
 */
import React, { useCallback, useEffect, useState } from "react";
import { Landmark, TrendingUp, Receipt } from "lucide-react";
...
export default function RealEstateModule({ onToast }: Props) {
